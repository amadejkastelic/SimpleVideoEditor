...
QT_INIT_METAOBJECT const QMetaObject MyVideoWidget::staticMetaObject = { {
    QMetaObject::SuperData::link<VideoRenderWidget::staticMetaObject>(),
    qt_meta_stringdata_MyVideoWidget.data,
    qt_meta_data_MyVideoWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *MyVideoWidget::qt_metacast(const char *_clname)
{
    ...
    return VideoRenderWidget::qt_metacast(_clname);
}

int MyVideoWidget::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = VideoRenderWidget::qt_metacall(_c, _id, _a);
    return _id;
}
QT_WARNING_POP
